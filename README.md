...
## PRO-TIP: HOW TO PRACTICE
    ...
    Install a VM: Use VirtualBox to experiment without breaking your main OS.

    WSL: If on Windows, enable WSL 2 for an instant terminal.

    The Mouse-Less Challenge: Try to navigate your entire system using only the keyboard.
